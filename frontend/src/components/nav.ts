...
export const NAV_BY_ROLE: Record<string, NavItem[]> = {
  ...
  branch_manager: [
    ...
    { label: "Collections", path: "/branch-manager/collections", icon: "archiveBox" },
  ],
  loan_vetting_committee: [
    { label: "Dashboard", path: "/committee", icon: "dashboard" },
    { label: "Committee Queue", path: "/committee/queue", icon: "documentText" },
    { label: "My Decisions", path: "/committee/decisions", icon: "checkCircle" },
  ],
  ...
  management: [
    ...
    { label: "Reports", path: "/management/reports", icon: "archiveBox" },
    { label: "Branch Ranking", path: "/management/branch-ranking", icon: "chartBar" },
